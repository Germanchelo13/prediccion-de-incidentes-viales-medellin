...
`r kbl(py$tabla_1, escape = F, align = "c", caption="Frecuencia de clase accidente.",row.names = T) %>%  kable_classic_2("striped", full_width = F)`
...
`r kbl(py$tabla_2, escape = F, align = "c", caption="Total NA por variable",row.names = T) %>%  kable_classic_2("striped", full_width = F)`
...
`r kbl(py$tabla_3, escape = F, align = "c", caption="Barrios y veredas en Medellín",row.names = T) %>%  kable_classic_2("striped", full_width = F)`
...
`r kbl(py$tabla_4, escape = F, align = "c", caption="Barrios que no estan en el mapa de Medellín",row.names = T) %>%  kable_classic_2("striped", full_width = F)`
...
`r kbl(py$tabla_5, escape = F, align = "c", caption="Línea de tiempo de los accidentes",row.names = T) %>%  kable_classic_2("striped", full_width = F)`
...
`r kbl(py$tabla_6, escape = F, align = "c", caption="Estructura inicial datos modelo predictivo",row.names = F) %>%  kable_classic_2("striped", full_width = F)`
...
`r kbl(py$fecha_accidente, escape = F, align = "c", caption="Días por año con registro de accidentes",row.names = T) %>%  kable_classic_2("striped", full_width = F)`
...
<figcaption> Figura 7: Box plot Número de accidentes por día de festivo dado la clase de accidente. </figcaption>
...
<figcaption> Figura 8: Box plot Número de accidentes por día después de quincena dado la clase de accidente. </figcaption>
...
`r kbl(py$tabla_8, escape = F, align = "c", caption="Variables a considerar",row.names = F) %>%  kable_classic_2("striped", full_width = F)`
...
`r kbl(py$tabla_9, escape = F, align = "c", caption="Resumen de validación",row.names = T) %>%  kable_classic_2("striped", full_width = F)`
...
`r kbl(py$tabla_10, escape = F, align = "c", caption="Medía predicción por clase",row.names = T) %>%  kable_classic_2("striped", full_width = F)`
...
<figcaption> Figura 12: </figcaption>
...
`r kbl(py$tabla_11, escape = F, align = "c", caption="Media predicción por clase con error de variación",row.names = F) %>%  kable_classic_2("striped", full_width = F)`
...
<figcaption> Figura 14: Total de accidentes por kilometro cuadrado según el año y el cluster </figcaption>
